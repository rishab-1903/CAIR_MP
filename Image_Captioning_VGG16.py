...
NUM_LAYERS = 2
LEARNING_RATE = 0.0003  # Lowered for stable convergence
BATCH_SIZE = 16  # Lowered to avoid memory issues
EPOCHS = 1
MAX_LENGTH = 40
CLIP_GRAD = 5.0  # Gradient clipping to prevent explosion
...
class EncoderCNN(nn.Module):
    def __init__(self, embed_size):
        ...
        self.features = vgg16.features  # Extract convolutional layers
...
for epoch in range(EPOCHS):
    ...
    for images, captions, lengths in tqdm(dataloader, desc=f"Epoch {epoch+1}/{EPOCHS}"):
        ...
        torch.nn.utils.clip_grad_norm_(decoder.parameters(), max_norm=CLIP_GRAD)  # Clip Gradients
